...
stderr.writelines(f"""{Gr}
    ___   ______________      __________  ___   ________ __
   /   | / ____/  _/ __ \    /_  __/ __ \/   | / ____/ //_/
  / /| |/ /    / // / / /_____/ / / /_/ / /| |/ /   / ,<   
 / ___ / /____/ // /_/ /_____/ / / _, _/ ___ / /___/ /| |  
/_/  |_\____/___/_____/     /_/ /_/ |_/_/  |_\____/_/ |_|  
                                                           

          {Wh}[ + ]  C O D E   B Y  S I A M  [ + ]  
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}--------------------------------
   :g g   :         {Wh}| {Gr}ACID - TRACKER - IP ADDRESS {Wh}|
   : o    `.        {Wh}|       {Gr}@CODE BY CODE     {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}| {Gr}ACID - TRACKER - PHONE NUMBER {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY SIAM       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|  {Gr}ACID - SHOW YOUR IP ADDRESS  {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY SIAM       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|    {Gr}ACID - TRACKER USERNAME    {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY SIAM       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
